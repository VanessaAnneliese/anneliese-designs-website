    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="w-full pt-10 pb-6 flex flex-col items-center">
        <Image
          ...
          height={90}
        />
        <p className="mt-3 tracking-[0.25em] uppercase" style={{ fontFamily: "var(--font-cormorant)", fontWeight: 300, fontSize: "23px", color: "#000" }}>
          Anneliese Designs
        </p>
      </header>
      ...
      <main className="flex-1 w-full max-w-2xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col items-center py-12 gap-3">
          ...
          <p className="tracking-[0.25em] uppercase" style={{ fontFamily: "var(--font-cormorant)", fontWeight: 500, fontSize: "23px", color: "#000" }}>
            Anneliese Designs
          </p>
